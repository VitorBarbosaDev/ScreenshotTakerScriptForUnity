...
public class TransparentScreenshotCameraController : MonoBehaviour
{
    ...
    [FormerlySerializedAs("tag")] [SerializeField] private string objecttag = "Plant"; // tag of the objects to take screenshots of
    private void Start()
    {
        ...
        GameObject[] plants = GameObject.FindGameObjectsWithTag(objecttag);
